...
class _ProgressScreenState extends State<ProgressScreen>
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      // Se mantienen secuenciales para evitar abrir la base de datos varias
      // veces en paralelo durante el primer frame de la pantalla.
      ...
      debugPrint('Progress: error cargando datos: $error');
      if (mounted && generation == _loadGeneration) {
        setState(() {
          _loadError = 'No se pudo cargar el progreso';
          _isLoading = false;
        });
      }
    }
